  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    try {
      ...
      try {
        ...
        // Account was created but session cookie setup failed.
        // Redirect to login so they can sign in normally.
  ...
  if (success) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-50 to-white px-4">
        <div className="w-full max-w-md rounded-2xl border border-green-100 bg-white p-10 text-center shadow-md">
